...
export default function TakeawayHomeSection() {
  return (
    <section
      id="emporter"
      className="bg-[var(--site-cream)] px-5 py-20 tablet:px-8 tablet:py-24 desktop:px-[90px] desktop:py-[120px]"
    >
        ...
        <div className="site-card mx-auto mt-12 grid max-w-[1180px] gap-8 rounded-[34px] px-6 py-8 tablet:px-8 tablet:py-10 desktop:grid-cols-[1fr_0.88fr] desktop:items-center desktop:px-12">
          <div>
            <p className="text-[18px] leading-[1.95] text-[var(--site-ink-soft)]">
              Retrouvez vos incontournables de la maison en version à emporter.
              Pizzas, recettes italiennes et suggestions du moment:
              l&apos;essentiel de notre cuisine reste disponible même quand vous
              choisissez de déguster chez vous.
            </p>
